...
public class AllScene implements Initializable {
    ...
    public void initialize(URL URL, ResourceBundle resourceBundle){
        File f1 = new File("src/Images/bed1.jpg");
        Image myImage1 = new Image(f1.toURI().toString());

        File f2 = new File("src/Images/bed2.jpg");
        Image myImage2 = new Image(f2.toURI().toString());

        File f3 = new File("src/Images/bed3.jpg");
        Image myImage3 = new Image(f3.toURI().toString());

        File f4 = new File("src/Images/chair2.jpg");
        Image myImage4 = new Image(f4.toURI().toString());

        File f5 = new File("src/Images/chair1.png");
        Image myImage5 = new Image(f5.toURI().toString());

        File f6 = new File("src/Images/chair3.png");
        Image myImage6 = new Image(f6.toURI().toString());

        File f7 = new File("src/Images/table2.jpg");
        Image myImage7 = new Image(f7.toURI().toString());

        File f8 = new File("src/Images/table3.png");
        Image myImage8 = new Image(f8.toURI().toString());

        File f9 = new File("src/Images/table1.jpg");
        Image myImage9 = new Image(f9.toURI().toString());
        ...
        image7.setImage(myImage7);
        image8.setImage(myImage8);
        image9.setImage(myImage9);
    }
